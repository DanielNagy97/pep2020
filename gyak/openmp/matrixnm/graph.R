...
data0 <- read.table('./results/matrixnm-szekv-R.txt')
data1 <- read.table('./results/matrixnm-par-R.txt')
...
figure1("./results/figure-p.eps", dataa, expression(paste("Futásidők az R paraméter függvényében")), 'R', 'Futási idő (s)', linelabels)
